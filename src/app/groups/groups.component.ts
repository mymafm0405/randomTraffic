...
export class GroupsComponent implements OnInit {
  ...
  ngOnInit() {
    // Get groups
    this.http
      .get("https://randomtraffic-default-rtdb.firebaseio.com//groups.json")
      .pipe(
        map((resGroups) => {
          const groupsArray = [];
  ...
  getStudentsData() {
    // Get students
    this.http
      .get("https://randomtraffic-default-rtdb.firebaseio.com/students.json")
      .pipe(
        map((resStudents) => {
          const studentsArray = [];
